...
const CourseListPage = lazy(() => import("./pages/CourseListPage/CourseListPage"));
...
const TermsOfServicePage = lazy(() => import("./pages/TermsOfService/TermOfServicePage"));
...
const DoubtLiveClassPage = lazy(() => import("./pages/DoubtLiveClassPage/DoubtLiveClassPage"));

// Admin Pages
const AdminDashboard = lazy(() => import("./pages/admin/AdminDashboard"));
const AdminCourseList = lazy(() => import("./pages/admin/AdminCourseList/AdminCourseList"));
const AdminCourseEdit = lazy(() => import("./pages/admin/AdminCourseEdit/AdminCourseEdit"));
const AdminUserList = lazy(() => import("./pages/admin/AdminuserList/AdminUserList"));
const AdminArticleList = lazy(() => import("./pages/admin/AdminArticleList/AdminArticleList"));
      ...
      <Routes location={location} key={location.pathname}>
          ...
          <Route element={<PrivateRoute />}>
            ...
            <Route path="learn/:courseId">
              ...
              <Route path="doubts" element={<DoubtPage />}>  
                <Route path="chat" element={<DoubtChatPage />} />
                <Route path="live" element={<DoubtLiveClassPage />} />
              </Route>
            </Route>
          </Route>
        </Route>
        ...
        <Route element={<AdminRoute />}>
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route path="courses/edit/:courseId" element={<AdminCourseEdit />} />
            <Route path="users" element={<AdminUserList />} />
            <Route path="articles" element={<AdminArticleList />} />
            <Route path="articles/edit/:articleId" element={<AdminArticleEdit />} />
